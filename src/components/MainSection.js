...
const MainSection = () => {
  ...
  const calculateTotalTimeSpent = (order) => {
    let totalTime = 0;
    const stageStartTimes = order.stageStartTimes || {};
      ...
      <table style={styles.tableStyle}>
        ...
        <tbody>
            ...
            return (
              <tr key={order.orderId}>
                ...
                <td style={styles.cellStyle}>
                  {minutes > 0 ? `${minutes} minutes` : ''} {seconds} sec
                </td>
                <td style={styles.cellStyle}>
          ...
          {ordersInProgress.length === 0 && (
            <tr>
              <td style={styles.cellStyle} colSpan={5}>
                NO ORDERS
              </td>
            </tr>
          )}
          <td style={styles.cellStyle}>Total order delivered:</td>
          <td style={{ ...styles.cellStyle, textAlign: 'left' }} colSpan={3}>
